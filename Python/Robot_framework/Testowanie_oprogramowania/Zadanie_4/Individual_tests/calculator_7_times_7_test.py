...
class TestGoogleCalculator7x7(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_seven_times_seven_equals_forty_nine(self) -> None:
        ...
        self.assertEqual("49", result.text)
        print(f"Test Passed: 7 * 7 = {result.text} OK")
...
if __name__ == "__main__":
    ...
    results_file = os.path.join(results_dir, "calculator_7x7_test_results.txt")
