...
class TestGoogleCalculator9Div3(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_nine_divided_by_three_equals_three(self) -> None:
        ...
        self.assertEqual("3", result.text)
        print(f"Test Passed: 9 / 3 = {result.text} OK")
...
if __name__ == "__main__":
    ...
    results_file = os.path.join(results_dir, "calculator_9_div_3_results.txt")
