...
class TestGoogleCalculatorNegation(unittest.TestCase): 
    def setUp(self) -> None:
    ...
    def tearDown(self) -> None:
        if self.driver:
            self.driver.quit()
    def test_negation_minus_five_plus_three_equals_negative_two(self) -> None:
...
if __name__ == "__main__":
    ...
    results_file = os.path.join(results_dir, "calculator_negation_-5+3_test.txt")
