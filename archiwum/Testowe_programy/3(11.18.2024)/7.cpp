...
- pobierz() - metoda pobiera wartości 2 zmiennych x i y. Obie zmienne muszą być dodatnie i żadna nie może być większa od 30.
...
public:
    ...
    void pobierz() {
        do {
            cout << "Podaj wartosc x (1-30): ";
            cin >> x;
            cout << "Podaj wartosc y (1-30): ";
            cin >> y;
