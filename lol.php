<?php
#/mnt/data/vhosts/casite-726602.cloudaccess.net/httpdocs/wp-content/plugins/mesmerize-pro/pro/inc/integrations/manual-theme-update/theme-updater.php
...
//		error_reporting( E_ALL );
	...
	private function create_backup( $directory ) {
		...
		$this->set_minimum_memory_limit( '1G' );
